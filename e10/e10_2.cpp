...
int main()
{
	std::shared_ptr<ColoredPoint> smart_ptr1 {new ColoredPoint{10, 20, Color::Green }};  // using new operator
	//auto smart_ptr1 {std::make_shared<ColoredPoint>( 10, 20, Color::Green )};  // using make_shared
